...
const Issue = ({issue}) => {
    ...
    return (
        <div className='bg-white p-4 gap-3 mb-4 rounded-lg shadow cursor-pointer text-black'>
            ...
            <div className='flex justify-between text-sm'>
                <div className='flex gap-2'>
                    ...
                    <p className={`font-semibold ${issue.priority=='HIGH PRIORITY' ? 'text-red-600' : issue.priority=='MEDIUM PRIORITY' ? 'text-yellow-600' : 'text-green-500'}`}>{priority}</p>
                </div>
